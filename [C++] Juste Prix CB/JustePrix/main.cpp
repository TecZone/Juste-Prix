...
int unsigned milieu(int unsigned difficulter, int unsigned joueur)
{
if (difficulter>joueur)
{
return (difficulter - joueur) / 2 + joueur;
}
else
{
return (joueur - difficulter) / 2 + difficulter;
}
}
...
PARAMETRE:
        ...
        case 2:
            ...
            std::cout << "|2__________________soluce mode|" << std::endl;
            ...
            case 2:
                ...
                if (solucemode == false)
                {
                    ...
                    solucemode = true;
                    std::cout << "********************************" << std::endl;
                    std::cout << "*******Soluce mode active*******" << std::endl;
                    std::cout << "********************************" << std::endl;
                    Sleep(2000);
                    white();
                    goto PARAMETRE;
                ...
                else
                {
                    ...
                    solucemode = false;
                    std::cout << "********************************" << std::endl;
                    std::cout << "*****Soluce mode desactive******" << std::endl;
                    std::cout << "********************************" << std::endl;
                    Sleep(2000);
                    white();
                    goto PARAMETRE;
            ...
            case 1:
                ...
                else
                {
                    ...
                    challenge = false;
                    std::cout << "********************************" << std::endl;
                    std::cout << "***Challenge mode desactive!****" << std::endl;
                    std::cout << "********************************" << std::endl;
                    Sleep(2000);
                    white();
                    goto PARAMETRE;
            ...
            case 5:
                ...
                std::cout << "| Trouve le bon nombre avec le |" << std::endl;
                std::cout << "| moin de coups possible grace |" << std::endl;
                std::cout << "|    aux indications donn�es   |" << std::endl;
                std::cout << "|                              |" << std::endl;
                std::cout << "|3_____________________________|" << std::endl;
                std::cout << "|                              |" << std::endl;
                std::cout << "================================" << std::endl;
    ...
    do
    {
        ...
        {
            if ((tentative == 5) || (tentative == 10) || (tentative == 15) || (tentative == 20) || (tentative == 25) || (tentative == 30) || (tentative == 35) || (tentative == 40))
            {
                white();
            }
            ...
            if(solucemode == true)
            {
                std::cout << "[SOLUCE] --- Essayer " << milieu(nbdifficulty, nbPlayer) << std::endl;
